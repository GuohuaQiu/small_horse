...
#define NOT_RECORD(v) ((v != VIEW_TYPE_RECORD_IN_ONE_COUNT)&&(v != VIEW_TYPE_RECORD_QUERY))
#define NOT_COUNTS(v) ((v != VIEW_TYPE_SUB_COUNTS)&&(v != VIEW_TYPE_MAIN_COUNTS))
#define IS_REPORT(v) (v == VIEW_TYPE_CREDIT_REPORT)
#define NOT_REPORT(v) (v != VIEW_TYPE_CREDIT_REPORT)
